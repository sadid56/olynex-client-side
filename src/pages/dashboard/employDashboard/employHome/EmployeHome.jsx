...
const EmployeHome = () => {
  ...
  const filterEmployeTask = filterComplete?.filter(task => task?.receiverId === singleUser?._id);
...
<div className="flex flex-col-reverse md:flex-row items-center">
    ...
    <div className="md:w-[30%]">
      ...
      <h4 className="text-center text-2xl  font-semibold">Your <span className="text-primary">performence</span></h4>
    </div>
</div>
<div>
<h3 className="text-2xl font-semibold my-5 mt-16 lg:mt-2">Your Complete <span className="text-primary">Project:</span></h3>
        {filterEmployeTask?.length === 0 ? (
          <p className="text-red-600 text-center mt-3">
            No complete any task!
          </p>
        ) : (
